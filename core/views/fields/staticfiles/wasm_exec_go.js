...
window.WASMLoaded = function(){
    let WASMInit = new EventTarget();
    WASMInit.On = function(callback){
      this.addEventListener("WASMInit", callback);
    }
    return WASMInit;
}()
...
let wasmFile = "/field-static-files/markdownify.wasm";

// Set up the loader
var LoadingText = "loading";
var container_id = "WASM-preload-container";
var inner_container_id = "WASM-preload-inner-container";
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    // and dispatch an event to let the user know that WASM is ready.
    window.onload = function () {
        mod.then(function (inst) {
            ...
            window.WASMLoaded.dispatchEvent(new Event("WASMInit"));
        });
    };
});
