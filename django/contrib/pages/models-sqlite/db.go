...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getNodesForPathStmt, err = db.PrepareContext(ctx, getNodesForPath); err != nil {
...
func (q *Queries) Close() error {
	...
	if q.getNodesForPathStmt != nil {
		if cerr := q.getNodesForPathStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getNodesForPathStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) models.Querier {
	return &Queries{
		...
		getNodesForPathStmt:        q.getNodesForPathStmt,
