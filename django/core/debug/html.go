...
func RenderStackTrace(s tracer.ErrorType, b requestWriter, r *http.Request) {
	b.WriteString("<div class=\"container\">")
	MedHeader(b, "Stack Trace")
	SubHeader(b, `An error has occurred, please consider looking at the following stacktrace.`)
	HorizontalRuleXS(b)
	var trace = s.Trace()
...
func RenderRequest(b requestWriter, r *http.Request) {
	b.WriteString("<div class=\"container\">")
	Header(b, "Request")
	HorizontalRuleXS(b)
