...
//go:linkname buildPathPart github.com/Nigel2392/go-django/src/contrib/pages.buildPathPart
func buildPathPart(numPreviousAncestors int) string

//go:linkname ancestorPath github.com/Nigel2392/go-django/src/contrib/pages.ancestorPath
