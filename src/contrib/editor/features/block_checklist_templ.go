...
func renderCheckList(fb editor.FeatureBlock, items []checkListItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/contrib/editor/features/block_checklist.templ`, Line: 44, Col: 66}
		}
		...
		for _, item := range items {
			var templ_7745c5c3_Var5 = []any{templ.KV("is-checked", item.Checked)}
