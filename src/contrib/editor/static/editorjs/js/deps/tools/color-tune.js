...
class BackgroundColorTune extends BaseColorTune {
    get buttonIcon() {
...
class TextColorTune extends BaseColorTune {
    get buttonIcon() {
        return btnTextColor;
    }
...
window.TextColorTune = TextColorTune;
window.BackgroundColorTune = BackgroundColorTune;