...
func (f *TestModelFields) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*TestModelFields] {
			return fattrs.FieldConfig[*TestModelFields]{
		...
		fattrs.NewField(f, "Name", func() fattrs.FieldConfig[*TestModelFields] {
			return fattrs.FieldConfig[*TestModelFields]{
		...
		fattrs.NewField(f, "Objects", func() fattrs.FieldConfig[*TestModelFields] {
			return fattrs.FieldConfig[*TestModelFields]{
...
func (f *TestEmbeddedModelFields) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*TestEmbeddedModelFields] {
			return fattrs.FieldConfig[*TestEmbeddedModelFields]{
				Config:   attrs.FieldConfig{Primary: true},
		...
		fattrs.NewField(f, "Name", func() fattrs.FieldConfig[*TestEmbeddedModelFields] {
			return fattrs.FieldConfig[*TestEmbeddedModelFields]{
		...
		fattrs.NewField(f, "Test", func() fattrs.FieldConfig[*TestEmbeddedModelFields] {
			return fattrs.FieldConfig[*TestEmbeddedModelFields]{
...
func (f *TestBindableValue) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*TestBindableValue] {
			return fattrs.FieldConfig[*TestBindableValue]{
				Config:   attrs.FieldConfig{Primary: true},
		...
		fattrs.NewField(f, "Name", func() fattrs.FieldConfig[*TestBindableValue] {
			return fattrs.FieldConfig[*TestBindableValue]{
		...
		fattrs.NewField(f, "Objects", func() fattrs.FieldConfig[*TestBindableValue] {
			return fattrs.FieldConfig[*TestBindableValue]{
...
func (f *TestBenchmarkWithCaching) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*TestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Age", func() fattrs.FieldConfig[*TestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "FirstName", func() fattrs.FieldConfig[*TestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "LastName", func() fattrs.FieldConfig[*TestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Title", func() fattrs.FieldConfig[*TestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Description", func() fattrs.FieldConfig[*TestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Objects", func() fattrs.FieldConfig[*TestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithCaching]{
...
func (f *TestBenchmarkWithoutCaching) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*TestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Age", func() fattrs.FieldConfig[*TestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "FirstName", func() fattrs.FieldConfig[*TestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "LastName", func() fattrs.FieldConfig[*TestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Title", func() fattrs.FieldConfig[*TestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Description", func() fattrs.FieldConfig[*TestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Objects", func() fattrs.FieldConfig[*TestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*TestBenchmarkWithoutCaching]{
