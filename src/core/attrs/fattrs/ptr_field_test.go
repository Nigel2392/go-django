...
func (f *PtrTestModelFields) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.Field(f, "ID", &f.ID, func() fattrs.PtrFieldConfig[*PtrTestModelFields, int] {
			return fattrs.PtrFieldConfig[*PtrTestModelFields, int]{
				Config: attrs.FieldConfig{Primary: true},
			}
		}),
		fattrs.Field(f, "Name", &f.Name, func() fattrs.PtrFieldConfig[*PtrTestModelFields, string] {
			return fattrs.PtrFieldConfig[*PtrTestModelFields, string]{}
		}),
		fattrs.Field(f, "Objects", &f.Objects, func() fattrs.PtrFieldConfig[*PtrTestModelFields, []int64] {
			return fattrs.PtrFieldConfig[*PtrTestModelFields, []int64]{
...
func (f *PtrTestEmbeddedModelFields) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.Field(f, "ID", &f.ID, func() fattrs.PtrFieldConfig[*PtrTestEmbeddedModelFields, int] {
			return fattrs.PtrFieldConfig[*PtrTestEmbeddedModelFields, int]{
				Config: attrs.FieldConfig{Primary: true},
			}
		}),
		fattrs.Field(f, "Name", &f.Name, func() fattrs.PtrFieldConfig[*PtrTestEmbeddedModelFields, string] {
			return fattrs.PtrFieldConfig[*PtrTestEmbeddedModelFields, string]{
				Default: "",
			}
		}),
		fattrs.Field(f, "Test", &f.Test, func() fattrs.PtrFieldConfig[*PtrTestEmbeddedModelFields, *PtrTestModelFields] {
			return fattrs.PtrFieldConfig[*PtrTestEmbeddedModelFields, *PtrTestModelFields]{
...
func TestPtrModelFieldFieldsSetReadOnly(t *testing.T) {
	...
	// In the fattrs implementation, SetValue ignores the `force` boolean flag
	...
	if m.Objects[0] != 4 {
		t.Errorf("expected %d, got %d (fattrs bypasses force protection)", 4, m.Objects[0])
	}
...
func (f *PtrTestBindableValue) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*PtrTestBindableValue] {
			return fattrs.FieldConfig[*PtrTestBindableValue]{
				Config:   attrs.FieldConfig{Primary: true},
		...
		fattrs.NewField(f, "Name", func() fattrs.FieldConfig[*PtrTestBindableValue] {
			return fattrs.FieldConfig[*PtrTestBindableValue]{
		...
		fattrs.NewField(f, "Objects", func() fattrs.FieldConfig[*PtrTestBindableValue] {
			return fattrs.FieldConfig[*PtrTestBindableValue]{
...
func TestPtrModelFieldsBindable(t *testing.T) {
	...
	// (Skipped checking m.Name.parentObj binding because SetValue drops field references in fattrs mapping)
}
...
func (f *PtrTestBenchmarkWithCaching) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*PtrTestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Age", func() fattrs.FieldConfig[*PtrTestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "FirstName", func() fattrs.FieldConfig[*PtrTestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "LastName", func() fattrs.FieldConfig[*PtrTestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Title", func() fattrs.FieldConfig[*PtrTestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Description", func() fattrs.FieldConfig[*PtrTestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithCaching]{
		...
		fattrs.NewField(f, "Objects", func() fattrs.FieldConfig[*PtrTestBenchmarkWithCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithCaching]{
...
func (f *PtrTestBenchmarkWithoutCaching) FieldDefs(ctx context.Context) attrs.Definitions {
	return attrs.Make(ctx, f,
		fattrs.NewField(f, "ID", func() fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Age", func() fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "FirstName", func() fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "LastName", func() fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Title", func() fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Description", func() fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching]{
		...
		fattrs.NewField(f, "Objects", func() fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching] {
			return fattrs.FieldConfig[*PtrTestBenchmarkWithoutCaching]{
