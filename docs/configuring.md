...
**Auth Settings (from `github.com/Nigel2392/go-django/contrib/auth`)**
...
**Admin Settings (from `github.com/Nigel2392/go-django/contrib/admin`)**
...
**Editor Settings (from `github.com/Nigel2392/go-django/contrib/editor`)**
...
**Messages Settings (from `github.com/Nigel2392/go-django/contrib/messages`)**

* `messages.APPVAR_COOKIE_KEY`: (`*http.Cookie`) Cookie settings used for the cookie-based messaging backend.

**Pages Settings (from `github.com/Nigel2392/go-django/contrib/pages`)**
