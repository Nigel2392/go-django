...
```bash
go get github.com/Nigel2392/go-django@v1.6.8.6
```
...
```bash
go install github.com/Nigel2392/go-django/cmd/go-django@v1.6.8.6
```

Or to install the SQLC plugin to auto- generate SQL queries and [go-django definitions](./docs/sqlc.md) from your SQL database.

```bash
go install github.com/Nigel2392/go-django/cmd/go-django-definitions@v1.6.8.6
```
